...
hc = HierarchicalClustering(linkage='centroid', X=X, pre_clustering_func=kmeans_pre_clustering, n_clusters=n_clusters)
print(f'Inizio fit')
hc.fit()
print('Fine fit')
...
max_clusters = 10  # Puoi modificare questo valore
